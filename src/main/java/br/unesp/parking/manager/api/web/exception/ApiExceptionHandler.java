package br.unesp.parking.manager.api.web.exception;

import br.unesp.parking.manager.api.exception.*;
...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler({UsernameUniqueViolationException.class, CpfUniqueViolationException.class, CodeUniqueViolationException.class, LicensePlateUniqueViolationException.class})
